      ...
      <section className="mx-auto grid min-h-screen w-full max-w-7xl gap-8 px-4 py-6 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-8 lg:py-10">
        <div className="flex flex-col gap-7">
          <nav className="flex items-center gap-3" aria-label="제품">
            ...
            <span className="rounded-full border border-[#c8b8ff] bg-white/80 px-3 py-1 text-xs font-bold text-[#3b168c] shadow-sm">
              Vercel live
            </span>
          </nav>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="space-y-3">
              ...
              <p className="inline-flex rounded-full border border-[#ded4ff] bg-white/70 px-4 py-2 text-sm font-semibold text-[#3b168c] shadow-sm">
